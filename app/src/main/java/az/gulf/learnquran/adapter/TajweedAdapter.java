...
/**
 * Created by www.ucuz.az on 06.02.2016.
 */
public class TajweedAdapter  extends RecyclerView.Adapter<TajweedAdapter.ViewHolder> {
    ...
    public TajweedAdapter(ArrayList<String> myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public TajweedAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                        int viewType) {
